...
execute as @a[tag=anim.momento.reviil] at @s run function cpaladeds3:animacion/momento-reviil
execute as @a[tag=anim.momento.nutria] at @s run function cpaladeds3:animacion/momento-nutria
